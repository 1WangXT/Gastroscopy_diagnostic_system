...
"border-radius:5px;}")
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(0, 55))  # 改名字的框架大小
...
"")
        ...
        self.groupBox_2.setMinimumSize(QtCore.QSize(0, 55))  # 设置 框大小
...
"")
        ...
        self.horizontalLayout_function.setContentsMargins(11, -1, 11, -1)
        self.horizontalLayout_function.setObjectName("horizontalLayout_function")

        self.label_function = QtWidgets.QLabel(self.groupBox_8)
        self.label_function.setMinimumSize(QtCore.QSize(0, 50))
        self.label_function.setMaximumSize(QtCore.QSize(80, 16777215))
        self.label_function.setStyleSheet("QLabel\n"
"{\n"
"    font-size: 20px;\n"
"    font-family: \"Microsoft YaHei\";\n"
"    font-weight: bold;\n"
...
"")
        ...
        self.comboBox_function = QtWidgets.QComboBox(self.groupBox_8)
        self.comboBox_function.setMinimumSize(QtCore.QSize(0, 50))
        self.comboBox_function.setStyleSheet("QComboBox QAbstractItemView {\n"
"font-family: \"Microsoft YaHei\";\n"
"font-size: 16px;\n"
...
"")
        ...
        self.horizontalLayout_handle = QtWidgets.QHBoxLayout()
        self.horizontalLayout_handle.setContentsMargins(11, -1, 11, -1)
        self.horizontalLayout_handle.setObjectName("horizontalLayout_handle")

        self.label_handle = QtWidgets.QLabel(self.groupBox_8)
        self.label_handle.setMinimumSize(QtCore.QSize(0, 50))
        self.label_handle.setMaximumSize(QtCore.QSize(80, 16777215))
        self.label_handle.setStyleSheet("QLabel\n"
                                          "{\n"
                                          "    font-size: 20px;\n"
                                          "    font-family: \"Microsoft YaHei\";\n"
                                          "    font-weight: bold;\n"
                                          ...
                                          "}\n"
                                          "")
        self.label_handle.setObjectName("label_function")
        self.horizontalLayout_handle.addWidget(self.label_handle)
        self.comboBox_handle = QtWidgets.QComboBox(self.groupBox_8)
        self.comboBox_handle.setMinimumSize(QtCore.QSize(0, 50))
        self.comboBox_handle.setStyleSheet("QComboBox QAbstractItemView {\n"
                                             "font-family: \"Microsoft YaHei\";\n"
                                             "font-size: 16px;\n"
                                             "background:rgba(200, 200, 200,150);\n"
                                             "selection-background-color: rgba(200, 200, 200,50);\n"
                                             ...
                                             "}\n"
                                             "")
        self.comboBox_handle.setObjectName("comboBox_function")
        self.comboBox_handle.addItem("")
        self.comboBox_handle.addItem("")
        self.horizontalLayout_handle.addWidget(self.comboBox_handle)
...
"")
        ...
        self.verticalLayout_8.addLayout(self.horizontalLayout_function)
        self.verticalLayout_8.addLayout(self.horizontalLayout_handle)
...
"border-radius:0px;}")
        ...
        self.fileButton.setMinimumSize(QtCore.QSize(50, 50))
        self.fileButton.setMaximumSize(QtCore.QSize(16777215, 50))
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "胃镜病灶辅助诊断系统"))
        self.label_4.setText(_translate("mainWindow", "胃镜病灶辅助诊断系统"))
        self.label_5.setText(_translate("mainWindow", "设置"))
        self.label_function.setText(_translate("mainWindow", "功能"))
        self.label_handle.setText(_translate("mainWindow", "图像"))
        self.label_3.setText(_translate("mainWindow", "模型网络"))
        self.comboBox_function.setItemText(0, _translate("mainWindow", "解剖部位分类"))
        self.comboBox_function.setItemText(1, _translate("mainWindow", "病理分类"))
        self.comboBox_function.setItemText(2, _translate("mainWindow", "病灶分割"))
        self.comboBox_function.setItemText(3, _translate("mainWindow", "病灶检测"))

        self.comboBox_handle.setItemText(0, _translate("mainWindow", "单个处理"))
        self.comboBox_handle.setItemText(1, _translate("mainWindow", "批量处理"))

        self.comboBox.setItemText(0, _translate("mainWindow", "ConvNeXt-MA(suggest).pt"))
        self.comboBox.setItemText(1, _translate("mainWindow", "ConvNeXt.pt"))
        self.comboBox.setItemText(2, _translate("mainWindow", "MobileNet.pt"))
        self.comboBox.setItemText(3, _translate("mainWindow", "ResNet.pt"))
        self.comboBox.setItemText(4, _translate("mainWindow", "Swim-Transformer.pt"))

        self.label_10.setText(_translate("mainWindow", "输入文件"))
